...
The installation process is easy since the [negotivo17 team](http://negativo17.org) has repackaged the ubuntu client for fedora. Here is how to install it:
```
...
```
Now it's time for muting the annoying ads. Follow this github [thread](https://gist.github.com/pcworld/3198763), and [this one](https://github.com/SecUpwN/Spotify-AdKiller).
